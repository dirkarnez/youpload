...
func getClient(scope string) *http.Client {
	...
	b, err := ioutil.ReadFile("client_secret_903484380168-b2d7gf85g3vk8a8b8f6f9j9qo13vrj8d.apps.googleusercontent.com.json")
	if err != nil {
...
func main() {
	flag.StringVar(&filename, "filename", "", "Name of video file to upload")
	flag.StringVar(&title, "title", "Test Title", "Video title")
	flag.Parse()
